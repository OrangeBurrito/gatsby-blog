...
<img src="insert pic"/>
<p className="photo-caption">Inefficiency of the proposed skim-feeding method</p>
...
<p className="photo-caption">Birds are a spectrum, explained with Darwin's finches</p>
...
<p className="photo-caption">The fabled turkey vulture by <a href="https://www.deviantart.com/kgmomo" target="_blank">KGMomo</a></p>
